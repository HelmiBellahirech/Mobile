...
//Tu castes à la fin pour insérer en base.
    ...
    public void update(Covoiturage t) {
         ...
         String req = "update covoiturage set  depart=?,arrive=?,prix=?,date_sys=?,date=?,heure=?,nbrPlaces=?,comfort=?,fumeur=? where ID = ?";
        PreparedStatement preparedStatement;
        java.util.Date date_util = new java.util.Date();
//Tu fais tes traitement sur date_util...
    ...
    public Covoiturage findId(Integer r) {
        ...
        try {
            ...
            while (resultSet.next()) {
                covoiturage = new Covoiturage (resultSet.getInt("ID"), resultSet.getString("depart"), resultSet.getString("arrive"), resultSet.getFloat("prix"), resultSet.getDate("date_sys"), resultSet.getDate("date"), resultSet.getString("heure"), resultSet.getInt("nbrPlaces"), resultSet.getString("comfort"), resultSet.getString("fumeur"), resultSet.getInt("ID_USER"));
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
